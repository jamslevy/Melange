...
from soc.views.helper import widgets, surveys, midterm
...
class View(base.View):
  ...
  def __init__(self, params=None):
    ...
    rights['show'] = ['checkIsMidtermSurveyReadable']
    ...
    new_params['create_extra_dynaproperties'] = {
        'survey_content': forms.fields.CharField(widget=midterm.MidtermEditSurvey(),
                                                 required=False),
  ...
  def _public(self, request, entity, context):
    ...
    this_survey = midterm_logic.create_survey_record(user, entity, request.POST)
    return True
  ...
  def _editContext(self, request, context):
    ...
    results = midterm.MidtermSurveyResults()

    context['supplemental'] = results.render(self._entity, self._params,
                                             filter={})
  ...
  def _editGet(self, request, entity, form):
    ...
    form.fields['survey_content'] = forms.fields.CharField(
        widget=midterm.MidtermEditSurvey(this_survey=entity.this_survey),
        required=False)
