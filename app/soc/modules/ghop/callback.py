...
from soc.modules.ghop.views import test
...
class Callback(object):
  ...
  def registerWithSitemap(self):
    ...
    self.core.registerSitemapEntry(test.view.getDjangoURLPatterns())
  ...
  def registerWithSidebar(self):
    ...
    self.core.registerSidebarEntry(test.view.getSidebarMenus)
