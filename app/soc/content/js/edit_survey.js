...
*/
  ...
  survey.bind('init', function () {
    ...
    widget.find('a.delete img').click(function () {
      ...
      var delete_this = confirm("Deleting this field will remove all answers" +
                                " submitted for this field. Continue?");
      if (delete_this) {
  ...
  */
  ...
  $('form').bind('submit', function () {
    ...
    */
    ...
    survey.find('.sortable').each(function () {
      ...
      'Add question': function () {
        ...
        if (field_name !== '') {
          ...
          case "short_answer":
            ...
            break;
          case "long_answer":
            new_field = "<textarea cols='40' rows='" + MIN_ROWS + "' class='long_answer'/>";
            break;
          case "selection":
            new_field = "<select><option></option>" + default_option + "</select>";
            break;
          case "pick_multi":
            new_field = "<fieldset class='fieldset'><input type='button' value='" + DEFAULT_OPTION_TEXT + "' /></fieldset>";
            break;
          case "choice":
            new_field = "<fieldset class='fieldset'><input type='button' value='" + DEFAULT_OPTION_TEXT + "' /></fieldset>";
            break;
